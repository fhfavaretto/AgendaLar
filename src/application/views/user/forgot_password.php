...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            /**
              * Evento: Botão de login "Clique"
              *
              * Faça uma chamada ajax para o servidor e verifique se as credenciais do usuário estão corretas.
              * Se sim, redirecione-o para a página desejada, caso contrário, exiba uma mensagem.
              */
