        ...
        <div role="tabpanel" class="tab-pane active" id="providers">
            <div class="row">
                ...
                <div class="record-details column col-xs-12 col-sm-7">
                    ...
                    <?php // Esta mensagem de formulário está fora da exibição de detalhes, de modo que pode ser
                     // visível quando o usuário tem uma visão do plano de trabalho ativa. ?>
